...
7. Under any annotation, click or press ~c~ to invoke
   ...
   considered as Known word, skipping adding overlay. You can change the word to
   level 5 while keep it hiding, but if you don't need it anymore, simply run
   ~paw-delete-word~ to delete it.
