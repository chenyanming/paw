...
(defcustom paw-ask-ai-prompt '(("拆解分析" . "拆解分析以下文字:{content}")
                               ("文章总结" . "总结以下文字:{content}")
                               ("根据上下文解释" . "我正在阅读{context}，以下是高亮的文字:{content}。解释它的意思。")
                               ("回答问题" . "回答以下问题: {content}")
                               ("头脑风暴" . "为{content}进行头脑风暴")
                               ("草拟大纲" . "为{content}草拟大纲")
                               ("草拟任何内容" . "为{content}草拟任何内容")
                               ("草拟电子邮件" . "为{content}草拟电子邮件")
                               ("草拟日记条目" . "为{content}草拟日记条目")
                               ("草拟会议议程" . "为{content}草拟会议议程")
                               ("12个字以内解释" . "为{content}用12个字以内解释")
                               ("48个字以内解释" . "为{content}用48个字以内解释")
                               ("100个字以内解释" . "为{content}用100个字以内解释")
                               ("200个字以内解释" . "为{content}用200个字以内解释")
                               ("总结一下" . "总结一下{content}")
                               ("翻译成中文" . "将{content}翻译成中文")
                               ("写任何内容" . "为{content}写任何内容")
