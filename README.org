...
* Configuration
** Configure paw.el
After installing the above Dependencies, you can configure paw like below, please note that csv dictionaries are not provided in this project, you can convert from Anki Deck or Make your own, it is just test based dictionaries:
#+begin_src emacs-lisp
