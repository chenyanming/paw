...
- [[https://github.com/Dushistov/sdcv][sdcv]] (command line tool)
- mpv (or other command line mp3 player)
- [[https://github.com/goldendict/goldendict][goldendict]]
- [[https://github.com/rany2/edge-tts/][edge-tts]] (pronunciation, command line tool)
- [[https://github.com/ikawaha/kagome][kagome]] (command line tool, For Japanese segmentation)
...
- Emacs packages (Not all all needed, some are optional, but paw just supports them):
...
3. Clone this repo to any place, and install ~paw~ command line by, but this is optional, it helps you setup the dependencies
        #+begin_src sh
        pip install .
        #+end_src

4. Please be patient... run the following command lines, you may need to adjust them based on your system, take mac for example:
        #+begin_src sh
        brew install sdcv
        brew install mpv
...
* Configuration
** Configure paw.el
After installing the above Dependencies, you can configure paw like below:
#+begin_src emacs-lisp
...
6. paw-server is optional, you don't need to run it, and still able to use the org-protocol feature.
