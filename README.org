...
1. Run ~paw-anki-configure-card-format~ to configure deck, note type, filed-name, and filed-values temporarily.
...
2. Configure ~paw-online-word-servers~, =(setq paw-online-word-servers '(anki))= to enable anki server, or =(setq paw-online-word-servers '(eudic anki))= to enable both eudic and anki servers.
