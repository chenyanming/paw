...
PS: Start from 1.1.3, paw has its own sdcv configurations for better future development, use the following configurations to support both [[https://github.com/manateelazycat/sdcv][sdcv.el]] and paw-sdcv:
