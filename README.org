...
But this feature is still under testing. If you edit text with the annotation
attached to, paw may not be able to find and show it on current buffer, but you
can still manage it in paw dashboard.
