...
1. Run ~paw-anki-configure-card-format~ to configure deck, note type, filed-name, and filed-values. Or set ~paw-anki-deck~, ~paw-anki-note-type~, ~paw-anki-field-names~ and ~paw-anki-field-values~ permanently.
