...
5. eaf-mode
6. eww-mode
7. wallabag-entry-mode
8. pdf-view-mode
9. elfeed-show-entry-mode
10. telega-webpage-mode
11. [[https://github.com/chenyanming/paw_org_protocol][Browser Support]]
...
- "Translation": The transalation of the word/annotation
